...
const forumSchema = z.object({
    ...
    uploaded_images: z
        ...
        .refine((files) => files.every(file => file.size <= 5000000), "Each file must be less than 5MB")
        .refine(
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    render={({ field: { onChange, value, ...field } }) => (
                        <FormItem>
                            ...
                            <p className="text-sm text-gray-500">
                                You can upload multiple images. Each image must be less than 5MB.
                ...
                {form.watch("uploaded_images") && (
                    <div className="grid grid-cols-2 gap-4 mt-4">
                        {Array.from(form.watch("uploaded_images") || []).map((file, index) => (
